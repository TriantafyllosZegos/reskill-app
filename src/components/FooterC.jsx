...
function FooterC() {
  return (
    <>
      <div className="footerContainer flex flex-col py-20">
        <hr />
        <div className="flex flex-row justify-between p-10 gap-20 ">
          <LeftSide />
          <RightSide />
        </div>
      </div>
...
const RightSide = () => (
  <div className="flex flex-row gap-40  items-center pr-20">
