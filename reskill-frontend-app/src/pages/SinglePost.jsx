    ...
    <>
      ...
      >
        <div className="flex flex-col col-span-1 gap-6 pr-4 tracking-tight ">
          <h1 className="font-[700] text-[64px] text-black  text-left tracking-tight">
        ...
        <div className="flex col-span-1 lg:col-span-1 justify-end pl-0 md:pl-16 lg:pl-28 pr-1 kg:pb-10 ">
          {/*IMAGE */}
